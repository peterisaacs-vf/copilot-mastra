...
- `references/anti-patterns.md` — the 8 common wiring mistakes (defaultValue from an unwritten var, shouldFulfill misuse, missing outputs, literal-name IDs, phantom inputs, prompt-instead-of-wiring, reading secrets in code, no guaranteed setter).
